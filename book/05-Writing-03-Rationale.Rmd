...
```{r structure figure, fig.alt = "Empirical report structure as an hourglass shape. Moving from broad to narrow in the introduction. Then narrow to broad in the discussion."}
...
```{r introduction highlight figure, fig.alt = "Empirical report structure as an hourglass shape. In this part, the introduction is highlighted in red to show it is the focus of this chapter."}
